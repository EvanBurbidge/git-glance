...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-start pt-20 w-full h-screen px-5 text-primary">
        ...
        <LoginTile provider="github enterprise" imgSrc={Git} showProviderInput={showProviderInput} onClick={setProvider}/>
